...
<body class="bg-gradient-brand min-h-screen flex items-center justify-center p-margin-page">
    <div class="w-full max-w-md">
        ...
        <div class="glass-card shadow-[0_24px_48px_rgba(23,26,74,0.24)] rounded-xl overflow-hidden border border-white/20 transition-all duration-250 ease-in-out">
            <div class="p-10">
                ...
                <!-- Removido o 'onsubmit="return false;"' para permitir o envio ao PHP -->
                <form class="space-y-6" method="POST" action="validar.php">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-outline">
                                <!-- Corrigido de 'Email' para 'email' (minúsculo) -->
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input class="w-full pl-12 pr-12 py-3 bg-surface-container-lowest border border-outline-variant rounded-lg font-body-md text-body-md text-on-surface placeholder:text-outline/50 focus:ring-2 focus:ring-primary-container focus:border-primary-container transition-all duration-250 outline-none" id="password" name="senha" placeholder="••••••••" required type="password" />
                            
                            <!-- Corrigido para type="button" para não disparar o formulário -->
                            <button id="togglePassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-outline hover:text-on-surface transition-colors duration-250" type="button">
    ...
    <!-- Script opcional para fazer o botão do olho realmente funcionar alternando a visibilidade da senha -->
    <script>
